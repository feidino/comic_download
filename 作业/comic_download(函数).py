    ...
    if choice_dit:
        ...
        while cont:
            ...
            if choice_dit[choice_num][0]:
                ...
                url_list = []
                url_list = comic_chapter_url(continue_link)
                comic_download(url_list)
                cont = 0   
            else:
                print('输入有误，请重新输入')
    else:
...
def comic_chapter_url(continue_link):
    start_url_list = []
...
def comic_download(start_url_list):
